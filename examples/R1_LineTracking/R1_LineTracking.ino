...
// DEFINE
#define PIN_SENSOR_RIGHT A1 //! A1
#define PIN_SENSOR_MID A2   //! A2
#define PIN_SENSOR_LEFT A3  //! A3
#define PIN_IN1 4           //! D4
#define PIN_IN2 5           //! D5
#define PIN_IN3 6           //! D6
#define PIN_IN4 7           //! D7
...
void loop()
{
  ...
  int eye_Left_Value = digitalRead(PIN_SENSOR_LEFT);
  int eye_Right_Value = digitalRead(PIN_SENSOR_RIGHT);
  int eye_Mid_Value = digitalRead(PIN_SENSOR_MID);
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            { // If the car was on the left last time

              demoMotor.car_rotateR(speedForward); // Let the car turn RIGHT
            }
            else
            { // If the car was on the right last time
